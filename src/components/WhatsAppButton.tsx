export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-8 right-8 z-50 flex items-center justify-center w-[60px] h-[60px] rounded-full shadow-lg transition-all duration-300 hover:scale-110"
