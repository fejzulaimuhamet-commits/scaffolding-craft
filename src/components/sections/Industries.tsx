...
export const Industries = () => {
  const eyebrow = "Für wen wir bauen";
  const titleLead = "Branchen, die auf uns zählen.";
  const intro = "Vom Dachdecker bis zum Hausbesitzer – wir kennen die Anforderungen jedes Gewerks und liefern das passende Gerüst.";
