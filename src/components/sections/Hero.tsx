    ...
    >
      ...
      <div className="container-w relative z-10 flex items-center pt-32 pb-20 lg:pt-36 lg:pb-28" style={{ minHeight: "85vh" }}>
        ...
        >
          ...
          {/* H1 */}
          <h1
            className="mt-6 font-display font-extrabold text-white leading-tight tracking-tight w-full text-4xl lg:text-[2.375rem] xl:text-[2.875rem] 2xl:text-[3.375rem]"
          >
            Gerüstbau in{" "}
