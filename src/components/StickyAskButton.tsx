...
export const StickyAskButton = () => {
  ...
  return (
    <Link
      ...
      onClick={() =>
        trackEvent("anfrage_click", {
          location: "floating_button",
          from: location.pathname,
        })
      }
      className="fixed z-50 right-4 sm:right-8 bottom-24 grid place-items-center h-14 w-14 lg:h-12 lg:w-12 rounded-full bg-primary text-primary-foreground shadow-[0_14px_30px_-8px_hsla(353,71%,50%,0.6)] transition-transform hover:scale-110 active:scale-95"
    >
