...
const Page = () => (
  <ServicePage
    slug="innengeruest"
    seoTitle="Innengerüst & Raumgerüst Hamburg mieten | Wietek Gerüstbau"
    seoDescription="Innengerüste & Raumgerüste in Hamburg für Hallen, Kirchen, Gewerbe & große Innenräume. Sicher, geprüft, Aufbau in 24–72 h. Jetzt Angebot anfordern!"
    ...
    intro={{
      ...
      paragraphs: [
        "Decken streichen, Stuck restaurieren, Lüftungstechnik installieren oder Beleuchtung montieren – sobald in großen Innenräumen gearbeitet wird, braucht es ein verlässliches Innengerüst. Wietek Gerüstbau plant und montiert Raumgerüste für gewerbliche Hallen, Kirchen, Theater, Treppenhäuser und Lagerhallen in Hamburg und ganz Norddeutschland.",
    ...
    audiences={{
      ...
      items: [
        { icon: Factory, title: "Gewerbliche Hallen", desc: "Wartung, Lüftung, Beleuchtung, Decken- und Hallenarbeiten." },
    ...
    faq={[
      {
        ...
        a: "Wir bauen Raumgerüste in praktisch jeder Höhe – vom 3 m hohen Wohnraum bis zur 25 m hohen Gewerbehalle.",
      },
      {
        q: "Werden Böden geschützt?",
        a: "Ja. Wir verteilen die Last über Verteilbohlen und weiche Auflagen, sodass empfindliche Böden (Parkett, Stein, Industrieestriche) nicht beschädigt werden.",
      },
      {
